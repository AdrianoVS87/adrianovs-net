  ...
  en: {
    ...
    projects: {
      ...
      ipen: {
        ...
        description: 'Statewide biometric security system for Santa Catarina\'s prison management (iPEN). Includes CBA module. Vendor/brand-agnostic architecture — Intelbras, Hikvision, any biometric hardware — zero code changes. Built as a Quarkus microservice within PAIPE/CIASC.',
        tech: 'Java 21 · Quarkus 3 · Angular · PostgreSQL · MS SQL Server · Docker',
        status: '',
      },
  ...
  pt: {
    ...
    projects: {
      ...
      ipen: {
        ...
        description: 'Sistema de segurança biométrica estadual para gestão prisional de Santa Catarina (iPEN). Inclui módulo CBA. Arquitetura vendor/brand-agnostic — Intelbras, Hikvision, qualquer hardware biométrico — zero alteração de código. Microserviço Quarkus desenvolvido na PAIPE/CIASC.',
        tech: 'Java 21 · Quarkus 3 · Angular · PostgreSQL · MS SQL Server · Docker',
        status: '',
      },
