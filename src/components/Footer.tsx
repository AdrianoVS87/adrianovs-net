    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex justify-center gap-6 mb-6">
          {socials.map(({ icon: Icon, label, href, hoverColor }) => (
            <a
              ...
              aria-label={label}
              className={`text-gray-600 ${hoverColor} transition-colors duration-200`}
            >
              <Icon />
            </a>
          ))}
        ...
        <div className="flex justify-center mt-6">
          <a
            href="#home"
            className="flex items-center gap-1 text-gray-600 hover:text-emerald-400 transition-colors text-xs font-mono group"
          >
